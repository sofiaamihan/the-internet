...
# TODO - By CSS selector for finding elements
# TODO - is there a better way to check for optional assertions

class TestDynamicContent:
    """Not Dynamic but works fine."""
    ...
    @pytest.mark.dynamic
    def test_dynamic_content_some(self, driver):
        ...
        # assert row3 != row3_new
        assert pic1 == pic1_new
        assert pic2 == pic2_new
        # assert pic3 != pic3_new